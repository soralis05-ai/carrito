...
class CartService:
    ...
    @staticmethod
    def add_item(product_id, quantity=1, user_id=None, session_id=None):
        """
    ...
    @staticmethod
    def remove_item(item_id, user_id=None):
        """
    ...
    @staticmethod
    def calculate_total(user_id=None, session_id=None):
        """
    ...
    @staticmethod
    def count_items(user_id=None, session_id=None):
        """
